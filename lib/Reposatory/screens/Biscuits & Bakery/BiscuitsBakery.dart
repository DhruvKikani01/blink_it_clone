...
class BiscuitsbakeryScreen extends StatefulWidget {
  const BiscuitsbakeryScreen({super.key});

  @override
  State<BiscuitsbakeryScreen> createState() => _BiscuitsbakeryScreenState();
}

class _BiscuitsbakeryScreenState extends State<BiscuitsbakeryScreen> {
  List tempList = [];
  List<Users> newData = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Uihelper.CustomText(text: "Biscuits & Bakery",
            color: Colors.black,
