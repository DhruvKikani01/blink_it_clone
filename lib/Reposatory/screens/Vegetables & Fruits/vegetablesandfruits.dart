...
class VegetablesandfruitsScreen extends StatefulWidget {
  const VegetablesandfruitsScreen({super.key});

  @override
  State<VegetablesandfruitsScreen> createState() =>
      _VegetablesandfruitsScreenState();
}

class _VegetablesandfruitsScreenState extends State<VegetablesandfruitsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Uihelper.CustomText(text: "Vegetables & Fruits",
              color: Colors.black,
