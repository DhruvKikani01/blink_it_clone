...
class Oilgheemasala extends StatefulWidget {
  const Oilgheemasala({super.key});

  @override
  State<Oilgheemasala> createState() => _OilgheemasalaState();
}

class _OilgheemasalaState extends State<Oilgheemasala> {
  List tempList = [];
  List<Users> newData = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Uihelper.CustomText(text: "Oil, Ghee & Masala",
            color: Colors.black,
