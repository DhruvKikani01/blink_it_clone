...
class AttadalriceScreen extends StatefulWidget {
  const AttadalriceScreen({super.key});

  @override
  State<AttadalriceScreen> createState() => _AttadalriceScreenState();
}

class _AttadalriceScreenState extends State<AttadalriceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Uihelper.CustomText(text: "Atta, Dal & Rice",
            color: Colors.black,
